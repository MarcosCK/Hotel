 ...
 * @author raide
 */
@WebServlet(urlPatterns = {"/PassagemServlet"})
public class PassagemServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet PassagemServlet</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h3> Itinerario: " + itinerario);
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            a.adicionar(itinerario, valor);
        } catch (SQLException ex) {
            Logger.getLogger(PassagemServlet.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
